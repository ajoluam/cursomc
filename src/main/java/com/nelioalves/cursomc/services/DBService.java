...
public class DBService {
	...
	public void instatiateTestDatabase() throws ParseException {
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "ajoluam@hotmail.com", "02609445482", TipoCliente.PESSOAFISICA, pe.encode("123") );
		cli2.addPerfil(Perfil.ADMIN);
		
		Set<String> telefones = new HashSet<>();
		telefones.addAll(Arrays.asList("34623689", "991681861"));
		cli1.setTelefones(telefones);
		cli2.setTelefones(telefones);
		...
		Endereco e3 = new Endereco(null, "Avenida Florian", "2106", null, "Centro", "38777012", c2, cli2);
